        ...
        <div class="teams">
            <div class="selecteam">
                ...
                <form action="/user/userinfo/setteam/" method="post">
                    ...
                    <label for="goals">Give a number of goals for that team</label><br>
                    <input type="number" name="goals" id="goals"><br>
                    <label for="assists">Give a number of assists for that team</label><br>
                    ...
                    foreach ($teams as $team) {
                        ...
                        <div class="team" data-teamid='<?=$team['teamid']?>'>
                            ...
                            <a href="/user/userinfo/?removeteam=<?=$team['teamid']?>">
                                Verwijder prediction van '<?=$team['teamname']?>'
                            </a>
                        </div>
                        <?php
                    }
